...
def main():
    ...
    text_data_loader = data.get_txt_data_loader(caption_files['test'], rnn_vocab, bow2vec, options.support_set_number, opt.batch_size, opt.workers, options.style, video2frames['test'], visual_feats['test'])
